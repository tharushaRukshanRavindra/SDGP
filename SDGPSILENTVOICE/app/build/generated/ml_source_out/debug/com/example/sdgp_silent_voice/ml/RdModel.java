...
public final class RdModel {
  ...
  private RdModel(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "rdModel.tflite", options);
  ...
  @NonNull
  public static RdModel newInstance(@NonNull Context context) throws IOException {
    return new RdModel(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static RdModel newInstance(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    return new RdModel(context, options);
  }
