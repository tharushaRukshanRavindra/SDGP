...
public final class SignModel9 {
  ...
  private SignModel9(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "signModel9.tflite", options);
  ...
  @NonNull
  public static SignModel9 newInstance(@NonNull Context context) throws IOException {
    return new SignModel9(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static SignModel9 newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new SignModel9(context, options);
  }
