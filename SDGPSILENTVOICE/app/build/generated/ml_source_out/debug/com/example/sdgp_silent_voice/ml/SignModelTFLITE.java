...
/**
 * Identify the most prominent object in the image from a set of 25 categories. */
public final class SignModelTFLITE {
  @NonNull
  ...
  private SignModelTFLITE(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "signModelTFLITE.tflite", options);
  ...
  @NonNull
  public static SignModelTFLITE newInstance(@NonNull Context context) throws IOException {
    return new SignModelTFLITE(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static SignModelTFLITE newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new SignModelTFLITE(context, options);
  }
