package com.example.sdgp_silent_voice.ml;
...
/**
 * Identify the most prominent object in the image from a set of 26 categories. */
public final class SignRecog {
  @NonNull
  ...
  private SignRecog(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "signRecog.tflite", options);
  ...
  @NonNull
  public static SignRecog newInstance(@NonNull Context context) throws IOException {
    return new SignRecog(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static SignRecog newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new SignRecog(context, options);
  }
